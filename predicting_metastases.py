...
class PredictingMetastases(BaseEstimator):
    def __init__(self, le: sklearn.preprocessing.LabelEncoder, n_estimators=90) -> None :
        self.logistic_learners_ = []
        self.random_forest = RandomForestClassifier(n_estimators=n_estimators, random_state=42, class_weight="balanced")
        self.fitted = False
    ...
    def _predict(self, X) :
        ...
        # res = pd.Series(self.le.inverse_transform(res))
        return res
